    ...
    gov_main_layout(
      gov_row(
        column(
          ...
          a(href = "mailto:school.workforce@education.gov.uk", "school.workforce@education.gov.uk", .noWS = c("after")), ".",
          br(),
          ...
          a(href = "mailto:school.workforce@education.gov.uk", "school.workforce@education.gov.uk", .noWS = c("after")), br(),
          h2("See the source code"),
          "The source code for this dashboard is available in our ",
          a(href = "https://github.com/dfe-analytical-services/dfe-awayday-demo-prep", "GitHub repository", .noWS = c("after")),
          ".",
          br()
        ),
        column(
